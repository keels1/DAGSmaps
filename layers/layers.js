...
var format_BspFelder_24 = new ol.format.GeoJSON();
var features_BspFelder_24 = format_BspFelder_24.readFeatures(json_BspFelder_24, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_BspFelder_24 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_BspFelder_24.addFeatures(features_BspFelder_24);
var lyr_BspFelder_24 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_BspFelder_24, 
                style: style_BspFelder_24,
                popuplayertitle: "Bsp Felder",
                interactive: true,
                    title: '<img src="styles/legend/BspFelder_24.png" /> Bsp Felder'
                });
...
lyr_BspFelder_24.set('fieldAliases', {'id': 'id', 'Notizen': 'Notizen', });
...
lyr_BspFelder_24.set('fieldImages', {'id': 'TextEdit', 'Notizen': 'TextEdit', });
...
lyr_BspFelder_24.set('fieldLabels', {'id': 'no label', 'Notizen': 'no label', });
lyr_BspFelder_24.on('precompose', function(evt) {
